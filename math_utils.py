...
def calc_included_angles_from_vectors(vecs1, vecs2, return_rad=False, epsilon=1e-7):
...
def calc_included_angles_from_coords(anchor_coords, coords1, coords2, return_rad=False, epsilon=1e-7):
    anchor_coords = np.array(anchor_coords)
    coords1 = np.array(coords1)
    coords2 = np.array(coords2)
    v1 = coords1 - anchor_coords
    v2 = coords2 - anchor_coords
    angs = calc_included_angles_from_vectors(v1, v2, return_rad, epsilon)
    return angs
